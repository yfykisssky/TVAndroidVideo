 ...
 */
public class PolicyIntroActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_policy_detial);
    ...
    private void getDataFromNet() {
        ...
        new NetDataTool(this).sendGet(NetDataConstants.GET_INFO+ NetDataConstants.INFO_EUME.POLICY_INFO, new NetDataTool.IResponse() {
            @Override

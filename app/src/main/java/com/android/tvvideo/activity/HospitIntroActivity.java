 ...
 */
public class HospitIntroActivity extends BaseActivity {
    ...
    private void getDataFromNet() {
        ...
        new NetDataTool(this).sendGet(NetDataConstants.GET_INFO+ NetDataConstants.INFO_EUME.HOSPITAL_INFO, new NetDataTool.IResponse() {
            @Override

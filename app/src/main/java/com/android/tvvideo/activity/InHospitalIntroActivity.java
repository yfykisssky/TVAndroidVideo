 ...
 */
public class InHospitalIntroActivity extends BaseActivity {
    ...
    private void getDataFromNet() {
        ...
        new NetDataTool(this).sendGet(NetDataConstants.GET_INFO+ NetDataConstants.INFO_EUME.INHOSPITAL_INFO, new NetDataTool.IResponse() {
            @Override
